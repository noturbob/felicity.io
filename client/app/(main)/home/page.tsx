...
import { Plus, Send, Smile, Frown, PartyPopper, BrainCircuit } from "lucide-react";
...
export default function DashboardPage() {
    ...
    return (
        <div className="flex flex-col gap-8 sm:gap-12">
            ...
            {/* SMALLER & LOWER CAROUSEL SECTION */}
            <motion.div
            ...
            >
                <Carousel className="w-full max-w-[280px] sm:max-w-xs md:max-w-sm lg:max-w-md">
                    ...
                    {/* The <CarouselPrevious> and <CarouselNext> components have been removed */}
                </Carousel>
            </motion.div>
