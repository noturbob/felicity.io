...
// FIX: Use the environment variable for the base server URL, with a fallback for local development.
...
export function SignupForm({ setAuthView, className, ...props }: SignupFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // FIX: Correctly construct the full API URL with a slash.
            ...
            <FieldGroup>
              ...
              <Field>
                <Button variant="outline" type="button" className="w-full" asChild>
                   {/* FIX: Correctly construct the full Google auth URL */}
